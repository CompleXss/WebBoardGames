...
const ENDPOINTS = {
    ...
    Users: {
        ...
        POST_EDIT_USER_NAME_URL: BASE_URL + '/user/edit/name?name=',
        POST_EDIT_USER_LOGIN_URL: BASE_URL + '/user/edit/login?login=',
        POST_EDIT_USER_PASSWORD_URL: BASE_URL + '/user/edit/password',
